...
const useStyles = makeStyles({
  ...
  navIcon: {
    ...
    "&:hover": {
      ...
      transform: "scale(1.2)",
      boxShadow:
        "4px 4px 4px rgba(198, 43, 49, 0.5), -2px -2px 4px rgba(208, 208, 208, 0.15)",
      "& svg": {
        fill: "#EB1C24",
      },
    },
  ...
  active: {
    borderRadius: "45px",
    backgroundColor: "#EB1C24 !important",
    transform: "scale(1.2)",
    "& svg": {
      fill: "#fff",
    },
    "&:hover": {
      ...
      transform: "scale(1.2)",
      boxShadow:
        "2px 2px 2px rgba(198, 43, 49, 0.5), -2px -2px 4px rgba(208, 208, 208, 0.15)",
      "& svg": {
        fill: "#fff",
      },
    },
    ...
    <List className={classes.navList}>
      {nav.map((item) => (
        <ListItem
          ...
          onClick={() => handleNav(item.link, item.id)}
        >
